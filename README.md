...
> *Created with care by [Utharam](https://utharam.in/)* • *Part of the **Spreadsheet Zoo** ([LedgerDuck 🦆](https://utharam.github.io/LedgerDuck/), [SheetHound 🐕](https://sheethound.utharam.workers.dev/), [SheetMonkey 🐒](https://utharam.github.io/excel-cleaner/))* • *Dedicated to **Veeran, the Indian Spitz** 🐾*
...
This project is proprietary and all rights are reserved by **[Utharam](https://utharam.in/)**.  
